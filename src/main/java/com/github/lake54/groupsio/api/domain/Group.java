...
public class Group
{
    ...
    /**
     * @param messageSelectionDefault
     * @param filesAccess
     * @param emailDeliveryDefault
     * @param wikiAccess
     * @param moderated
     * @param created
     * @param updated
     * @param handleAttachments
     * @param calendarAccess
     * @param privacy
     * @param maxPhotoSizeEmail
     * @param disableEdits
     * @param newUsersModerated
     * @param replyTo
     * @param plainTextOnly
     * @param closeThreadsAfter
     * @param forceHtmlEmails
     * @param autoCloseThreads
     * @param maxAttachmentSizeDefault
     * @param subgroupAccess
     * @param photosAccess
     * @param desc
     * @param subjectTag
     * @param announce
     * @param object
     * @param id
     * @param allowNonSubsToPost
     * @param title
     * @param maxPhotoSizeDatabases
     * @param maxPhotoSizeWikiImages
     * @param moderateThreadsAfter
     * @param autoModerateThreads
     * @param name
     * @param hashTagsRequired
     * @param normalizeHtmlEmails
     * @param allowPhotosInFiles
     * @param disableNoEmail
     * @param restrictCreateHashTags
     * @param alias
     * @param website
     * @param unmoderateUsersAfter
     * @param restricted
     * @param bounceAttachments
     * @param chatAccess
     * @param removeOtherReplyOptions
     * @param footer
     * @param autoFollowRepliesDefault
     * @param databaseAccess
     * @param membersVisible
     * @param memberDirectoryAccess
     * @param pollsAccess
     * @param maxPhotoSizePhotos
     */
